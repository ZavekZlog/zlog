...
test('live schema allowlist matches introspected OpenAPI snapshot', () => {
...
test('diary page session expiry recovers via Sign in to Save (not enabled Save Changes)', () => {
  ...
  assert.match(page, /Save Site Diary/)
  assert.match(page, /✓ Site Diary Saved/)
  assert.match(page, /showSaveBanner/)
  assert.match(page, /✓ Your Site Diary has been saved\./)
