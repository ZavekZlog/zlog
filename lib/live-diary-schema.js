...
export const LIVE_DAILY_REPORTS = {
  ...
  columns: [
    ...
    'temporary_works',
    /** Permit to Work rows — persisted via finalize_site_diary_save when column exists. */
    'permits',
  ],
}
...
export function buildLiveDailyReportUpdatePayload(input) {
  ...
  const raw = {
    ...
    visitors_register_provenance:
      src.visitors_register_provenance == null ? [] : src.visitors_register_provenance,
    ...
    permits: src.permits == null ? [] : src.permits,
  }
