...
describe('12–13. Project link and Project Day', () => {
  ...
  it('locks Weather → Labour → H&S in compose/edit and saved review', () => {
    ...
    assert.ok(editHsHost > labourMountIdx)
    ...
    assert.ok(savedHs > savedLabour, 'saved review must not render Labour below H&S')
  })
