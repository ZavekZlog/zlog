 ...
 * @param {{ supabase: import('@supabase/supabase-js').SupabaseClient, router: import('next/navigation').AppRouterInstance, editingReportId: string|null, editingProjectId: string|null }} opts
 */
