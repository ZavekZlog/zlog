/**
 * Site Diary linked-project programme view model — sticky fields, dates, Project Day.
 * Used for compact Project Day status (and tests). Not a workbench recap card.
 */
