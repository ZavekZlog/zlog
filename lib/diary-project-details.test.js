...
describe('diary PROJECT card — programme dates', () => {
  it('linked project and selector SELECT include start_date and planned_completion_date', () => {
  ...
  it('visible PROJECT card shows both dates and Project Day X of Y', () => {
  ...
  it('refresh / reopen keeps the same PROJECT card values', () => {
    const row = {
      id: 'proj-1',
      start_date: '2026-08-01',
      planned_completion_date: '2026-09-19',
