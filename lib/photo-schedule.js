...
/**
 * Page chrome title for one work-photo area — the area name itself (visible).
 * Do not bury the name after a long "Photographic record —" prefix in letterspaced chrome.
 */
