...
/**
 * Optional "Assigned to" value for a photo tile.
 * Blank returns '' so PDF can omit the line entirely.
 */
...
/**
 * PDF display line for Assigned to — empty when no value (do not render label alone).
 */
